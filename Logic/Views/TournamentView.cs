...
namespace Logic.Views
{
    public class TournamentView
    {
        ...
        public TournamentView(string description, string location, int registeredPlayers, int minPlayers, int maxPlayers, DateTime startDate, DateTime endDate, string sportName, string systemName)
        {
